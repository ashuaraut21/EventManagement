...
public class add_location extends AppCompatActivity {
    EditText location,owner,address,pincode,lati,langi,area,contact,email,pass,key1,key2,key3;
                                        ...
                                        if (langi.length() > 0) {
                                            if (contact.length() == 10) {
                                                if (pass.length() > 0) {
                                                    ...
                                                    String url1 = "http://mahavidyalay.in/AcademicDevelopment/EventManagment/location_register.php?name=" + URLEncoder.encode(location.getText().toString())
                                                            ...
                                                            + "&key1=" + URLEncoder.encode(key1.getText().toString())
                                                            + "&key2=" + URLEncoder.encode(key2.getText().toString())
                                                            + "&key3=" + URLEncoder.encode(key3.getText().toString())
    ...
    private class Location extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            progress = ProgressDialog.show(add_location.this, null,
        ...
        protected void onPostExecute(String result) {
            ...
            Toast.makeText(add_location.this, ""+result, Toast.LENGTH_LONG).show();
            progress.dismiss();
            ...
            Intent register_i1 = new Intent(add_location.this, admin.class);
