...
public class location_delete_show extends AppCompatActivity {
    ListView listview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_location_delete_show);
        listview=(ListView)findViewById(R.id.listview);
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String item=listview.getItemAtPosition(position).toString();
                Intent show_i1= new Intent(location_delete_show.this,location_delete.class);
    ...
    private void loadIntoListView(String json) throws JSONException {
        ...
        LevelAdapter1 leveladapter=new LevelAdapter1(location_delete_show.this,name,owner,address);
